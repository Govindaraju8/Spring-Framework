...
<body>
<form action="patientdetailsentry" method="GET">
	<div class="container mt-5">
		...
		<div>
		<button id="bookButton" class="btn btn-success" disabled>Book</button>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function(response){
             ...
             // Add an event listener for the slots dropdown
                $('#slotDropdown').on('change', '#slotsSelect', function () {
                    var selectedSlot = $(this).val();
                    // Enable the "Book" button if a valid slot is selected, else disable it
                    if (selectedSlot) {
